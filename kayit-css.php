...
<html lang="ar" >
  ...
  <style>
        body {
            background-image: url('images/resim4.jpg'); /* Arka plan resmi */
        ...
        .container {
            background: rgba(0, 0, 0, 0.2); /* Form arka planı için yarı şeffaf bir katman */
            border-radius: 15px;
            padding: 30px;
            max-width: 500px;
            margin-top: 100px;
            box-shadow: 0 0 20px rgba(0, 0, 0, 0.2); /* Gölge efekti */
        }

        .form-label {
            font-weight: bold;
            color: #11009E; /* Başlık rengi */
        }
